...
def measure_sigma(band_no):
    ...
    if band_no==3:
        ...
        freq_upper=3.7*10**11
        aperture_eff=0.74
        ref_flux=8*10**2 #band 7 flux for HD 100546 in Jy from SED
...
def disk_contour(distance,centre_ra=3.0256,centre_dec=-1.22513):
    ...
    #this is a bit of a temporary fix since arange was being weird
